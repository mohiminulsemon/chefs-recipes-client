...
const Blog = () => {
  return (
    <div className="blog">
      ...
      <p>
        In React, controlled components refer to components that we can validate
        as the input is being changed. But in Uncontrolled components that is
        not possible.
      </p>
      ...
      <p>
        ...
        some example of propstype validation:
      ...
      <p>
        Express js is simply a node. js web application framework. On the other
        hand, Node. js is the package, which provides the JavaScript run-time
        environment.
      </p>
